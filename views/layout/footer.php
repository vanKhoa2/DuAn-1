                        ...
                        <div class="widget-body">
                            <address class="contact-block">
                                <ul>
                                    ...
                                    <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">duan1nhom2@gmail,com </a></li>
                                    <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">0925 883 277</a></li>
                                </ul>
                            </address>
                        </div>
                    </div>
            ...
            <div class="row align-items-center mt-20">
                <div class="col-md-6">
                    <div class="newsletter-wrapper">
                        <h6 class="widget-title-text">Đăng ký nhập bản tin</h6>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright-text text-center">
                        <p>&copy; 2024 <b>Adidas</b> Được thực  hiện <i class="fa fa-heart text-danger"></i> bởi <a href="https://hasthemes.com/"><b>Nhóm 2</b></a></p>
                    </div>
                </div>
            </div>
        </div>
